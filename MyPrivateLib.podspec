...
Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
                    this is MyPrivateLib
                   DESC

  s.homepage     = "https://github.com/VineFiner/MyPrivateLib"
  ...
  s.source       = { :git => "https://github.com/VineFiner/MyPrivateLib.git", :tag => s.version.to_s }
  ...
  s.source_files  = "MyPrivateLib/MyPrivateLib/**/*.{h,m}"
